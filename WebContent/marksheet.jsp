...
<head>
    ...
    <title>Official Marksheet - University of Lucknow ERP</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="css/style.css?v=6.0">
    <style>
        /* ---- PRINT LAYOUT: University Marksheet ---- */
        ...
        @media print {
            ...
            .badge-gold { background: none !important; border: 1px solid #000 !important; color: #000 !important; padding: 2px 8px !important; font-size: 9pt !important; }
            ...
            .summary-bar-print span { font-size: 11pt; color: #000 !important; }
            .summary-bar-print strong { font-size: 13pt; color: #000 !important; font-weight: bold; }
            ...
            .signature-row div { text-align: center; width: 200px; border-top: 1px solid #000; padding-top: 4px; }
        }
    </style>
</head>
<body>
        ...
        <main class="main-content">
            ...
            <div class="glass-card" style="padding: 32px; margin-bottom: 24px;" id="marksheetPrintArea">
                ...
                <div class="print-only print-header">
                    <div class="univ-name">University of Lucknow</div>
                    <div class="univ-sub">Lucknow, Uttar Pradesh — Established 1867</div>
                    <div class="doc-title">Official Academic Marksheet</div>
                </div>

                <!-- ---- SCREEN HEADER (gold + icon) ---- -->
                <div class="screen-only" style="text-align: center; margin-bottom: 24px; border-bottom: 2px solid var(--gold-border); padding-bottom: 16px;">
                    ...
                    <p style="color: var(--gold-light); font-size: 0.95rem; font-weight: 700; letter-spacing: 1px;">OFFICIAL ACADEMIC TRANSCRIPT / MARKSHEET</p>
                </div>
                ...
                <div class="print-only info-print-grid">
                    ...
                    <p>Email: <strong><%= selectedStudent.getEmail() != null ? selectedStudent.getEmail() : "—" %></strong></p>
                    <p>Print Date: <strong><%= java.time.LocalDate.now() %></strong></p>
                </div>
                ...
                <div class="screen-only" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 24px; font-size: 0.95rem;">
                    ...
                    <div style="text-align: right;">
                        ...
                        <p style="color: var(--text-muted); margin-top: 6px;">Date: <strong style="color: #ffffff;"><%= java.time.LocalDate.now() %></strong></p>
                    </div>
                </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        %>
                            <tr>
                                <td style="font-weight: 800; color: var(--gold-light);"><%= m.getSubjectCode() %></td>
                                <td style="font-weight: 600;"><%= m.getSubjectName() %></td>
                                <td><%= m.getExamType() != null ? m.getExamType() : "—" %></td>
                                <td style="font-weight: 700;"><%= String.format("%.1f", m.getMarksObtained()) %></td>
                                <td><%= String.format("%.1f", m.getMaxMarks()) %></td>
                                <td><span class="badge-gold"><%= m.getGrade() %></span></td>
                            </tr>
                        <% 
                                }
                            } else {
                ...
                <div class="print-only summary-bar-print">
                    <div>
                        ...
                        <strong><%= totalObtained != null ? String.format("%.1f", totalObtained) : "0" %> / <%= totalMax != null ? String.format("%.1f", totalMax) : "0" %></strong>
                    </div>
                    <div>
                        <span>Overall Percentage: </span>
                        <strong><%= String.format("%.2f", overallPercentage) %>%</strong>
                    </div>
                </div>
